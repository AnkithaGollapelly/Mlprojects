# read the data from big data source
import os
import sys
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            # Read dataset
            df = pd.read_csv(os.path.join('notebook', 'stuperform.csv'))
...
if __name__ == "__main__":
    ...
    model_metrics = model_trainer.initiate_model_trainer(train_array, test_array)
